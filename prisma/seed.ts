...
async function main() {
  ...
  // Teams
  const teamDefs = [
    { name: 'Web Platform', pmFte: 1, productManagerFte: 0.5, businessAnalystFte: 0.5, scrumMasterFte: 0.5, architectFte: 1, developerFte: 4.0, qaFte: 1.5, devopsFte: 1.0, dbaFte: 0, kloTlmHoursPerWeek: 15, adminPct: 20, skills: ['React', 'TypeScript', 'Node.js', 'AWS', 'GraphQL'] },
    { name: 'Business Applications', pmFte: 1, productManagerFte: 0.5, businessAnalystFte: 1.5, scrumMasterFte: 0.5, architectFte: 0.5, developerFte: 3.5, qaFte: 1.5, devopsFte: 0.5, dbaFte: 0.5, kloTlmHoursPerWeek: 20, adminPct: 22, skills: ['Salesforce', '.NET', 'SQL Server', 'Power Platform', 'ServiceNow'] },
    { name: 'ERP & Supply Chain', pmFte: 1.5, productManagerFte: 0, businessAnalystFte: 2.0, scrumMasterFte: 0, architectFte: 1.0, developerFte: 5.0, qaFte: 2.0, devopsFte: 1.0, dbaFte: 1.0, kloTlmHoursPerWeek: 30, adminPct: 18, skills: ['SAP S/4HANA', 'ABAP', 'SAP BTP', 'EDI', 'Oracle'] },
    { name: 'Data & Analytics', pmFte: 0.5, productManagerFte: 0.5, businessAnalystFte: 1.0, scrumMasterFte: 0, architectFte: 1.0, developerFte: 3.0, qaFte: 1.0, devopsFte: 0.5, dbaFte: 1.5, kloTlmHoursPerWeek: 12, adminPct: 20, skills: ['Snowflake', 'dbt', 'Python', 'Tableau', 'Spark', 'Airflow'] },
    { name: 'Infrastructure & Cloud', pmFte: 0.5, productManagerFte: 0, businessAnalystFte: 0, scrumMasterFte: 0, architectFte: 1.0, developerFte: 2.0, qaFte: 0.5, devopsFte: 3.0, dbaFte: 0, kloTlmHoursPerWeek: 40, adminPct: 15, skills: ['AWS', 'Azure', 'Terraform', 'Kubernetes', 'Linux', 'Networking'] },
    { name: 'Cybersecurity', pmFte: 0.5, productManagerFte: 0, businessAnalystFte: 0.5, scrumMasterFte: 0, architectFte: 1.0, developerFte: 2.0, qaFte: 1.0, devopsFte: 1.0, dbaFte: 0, kloTlmHoursPerWeek: 20, adminPct: 20, skills: ['SIEM', 'IAM', 'Penetration Testing', 'Zero Trust', 'Compliance'] },
    { name: 'Mobile & Digital', pmFte: 0.5, productManagerFte: 1, businessAnalystFte: 0.5, scrumMasterFte: 0.5, architectFte: 0.5, developerFte: 3.0, qaFte: 1.0, devopsFte: 0.5, dbaFte: 0, kloTlmHoursPerWeek: 10, adminPct: 20, skills: ['React Native', 'Swift', 'Kotlin', 'Firebase', 'Flutter'] },
  ];
  ...
  console.log(`✅ Seeded: 1 org, 2 users, ${teams.length} teams, ${projects.length} projects, ${estimateDefs.length} estimates, 3 scenarios, ${resourceDefs.length} resources`);
}
